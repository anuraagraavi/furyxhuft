      ...
      <Section id="gallery" bg="cream">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
          {IMAGES.gallery.map((src, i) => (
             <div key={i} className="relative group rounded-3xl overflow-hidden break-inside-avoid shadow-sm hover:shadow-md transition-all duration-300">
               <img src={src} alt="Gallery" className="w-full object-cover transition-transform duration-700 group-hover:scale-105" />
